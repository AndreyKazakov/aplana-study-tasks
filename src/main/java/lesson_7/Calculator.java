...
public class Calculator implements IShow {
    ...
    public void performCalculation(double operand1, double operand2, String operation) throws ArithmeticException, CustomMathOperationException { //throws is not necessary here since there are only RuntimeExceptions
        switch (operation) { //selects method for calculation according to entered sign
            ...
            case "/":
                ...
                break;
            default:
                throw new CustomMathOperationException("Unrecognized operation!");
        }
    }
